                                    ...
                                    <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                                        <div data-kt-search-element="wrapper">
                                            <form data-kt-search-element="form" class="w-100 position-relative mb-3" autocomplete="off">
                                                ...
                                                <input type="text" class="search-input form-control form-control-flush ps-10" id="search_ka" name="search" value="" placeholder="Search..." data-kt-search-element="input" />
                                                <span data-kt-search-element="spinner"></span>
                                                <span class="position-absolute top-50 end-0 translate-middle-y lh-0 d-none me-1" id="spinner_search">
                                                ...
                                                <div class="position-absolute top-50 end-0 translate-middle-y" data-kt-search-element="toolbar">
                                                    <span data-kt-search-element="preferences-show" ></span>
                                                    ...
                                                    <span data-kt-search-element="advanced-options-form-show" ></span>
                                            ...
                                            <span data-kt-search-element="results" ></span>
                                            ...
                                            <span data-kt-search-element="empty" ></span>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            const input = document.getElementById('search_ka');

            input.addEventListener('keyup', () => {
                const valor = input.value.trim();

                if (valor.length >= 3) {
                    var elemento = document.getElementById("spinner_search");
